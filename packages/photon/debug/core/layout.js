 ...
 */
export function childrenOnPath(parentModel, onPath, baseline = 0, reversed = false, contain = false, rotate = true) {
 ...
 * @returns The parentModel, for cascading.
 */
export function childrenOnChain(parentModel, onChain, baseline = 0, reversed = false, contain = false, rotated = true) {
    const result = getChildPlacement(parentModel, baseline);
    const cpa = result.cpa;
 ...
 */
export function cloneToRadial(itemToClone, count, angleInDegrees, rotationOrigin) {
    const result = {};
    let add;
    let rotateFn;
 ...
 */
export function cloneToColumn(itemToClone, count, margin = 0) {
 ...
 */
export function cloneToRow(itemToClone, count, margin = 0) {
 ...
 */
export function cloneToGrid(itemToClone, xCount, yCount, margin) {
 ...
 */
export function cloneToBrick(itemToClone, xCount, yCount, margin) {
    const margins = getMargins(margin);
 ...
 */
export function cloneToHoneycomb(itemToClone, xCount, yCount, margin = 0) {
    function spacing(modelToMeasure) {
