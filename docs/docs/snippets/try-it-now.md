...
title: Try It Now
---
Visit the [Maker.js Playground](../playground/index.html) to edit and run JavaScript from your browser.

Each of the [demos](../demos/index.html) will also open in the playground so that you can explore and modify their code.
