...
// Load JSON without import assertions for broader Node compatibility
const project = JSON.parse(
  fs.readFileSync(new URL('../dist/project.json', import.meta.url), 'utf-8')
);
...
// Emit a local ICascade so generated interfaces can extend it without external imports
out.write(`${indent}export interface ICascade {\n`);
out.write(`${indent2}$initial: any;\n`);
out.write(`${indent2}$result: any;\n`);
out.write(`${indent2}$reset: () => this;\n`);
out.write(`${indent}}\n\n`);
