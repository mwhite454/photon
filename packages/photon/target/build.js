...
fs.appendFileSync(js, 'Photon.version = "' + require('../package.json').version + '";\n');
...
b.bundle(function (err, buf) {
    ...
    fs.writeFileSync('./dist/browser.photon.js', browserCode, utf8);

    //also copy to web
    fs.writeFileSync('../../docs/target/js/browser.photon.js', browserCode, utf8);
